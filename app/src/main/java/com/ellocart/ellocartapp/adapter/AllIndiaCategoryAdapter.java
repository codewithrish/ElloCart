...
public class AllIndiaCategoryAdapter extends RecyclerView.Adapter<AllIndiaCategoryAdapter.ViewHolder> {

    private final Context context;
    private final List<CategoryItem> categoryItems;

    public AllIndiaCategoryAdapter(Context context, List<CategoryItem> categoryItems) {
